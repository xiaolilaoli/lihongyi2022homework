...
def main(args):
    ...
    train_loader = getDataLoader(filepath, 'train', False,args.eval.batch_size, transform=get_aug(train=False, train_classifier=True, **args.aug_kwargs))
    ...
    for epoch in global_progress:
        loss_meter.reset()
        if acc_meter.avg*100 > 65 or flag ==1:
            model.train()
            flag = 1
        else:
            model.eval()
